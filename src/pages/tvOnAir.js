...
export function TvOnAir(){
    ...
    useEffect(() => {
        axios.get('https://api.themoviedb.org/3/tv/on_the_air?api_key=15e383204c1b8a09dbfaaa4c01ed7e17&language=en-US&page=1').then(response => {
...
// https://api.themoviedb.org/3/tv/on_the_air?api_key=15e383204c1b8a09dbfaaa4c01ed7e17&language=en-US&page=1